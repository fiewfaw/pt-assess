...
function visitForm() {
  ...
  return {
    ...
    // Berg Balance Scale — 14 ข้อ 0-4 (4=ดีสุด) · c=[เกณฑ์ 4,3,2,1,0]
    bbs_opts: [0,1,2,3,4],
    bbs_items: [
      { key:'b1',  label:'1. ลุกจากนั่งเป็นยืน', c:['ไม่ใช้มือ ทรงตัวเอง','ใช้มือช่วย','ใช้มือ+ลองหลายครั้ง','ช่วยเล็กน้อย','ช่วยปานกลาง–มาก'] },
      { key:'b2',  label:'2. ยืนไม่พยุง (2 นาที)', c:['2 นาที ปลอดภัย','2 นาที ต้องเฝ้า','30 วิ','หลายครั้งกว่าจะ 30 วิ','<30 วิ'] },
      { key:'b3',  label:'3. นั่งไม่พยุง เท้าแตะพื้น (2 นาที)', c:['2 นาที ปลอดภัย','2 นาที ต้องเฝ้า','30 วิ','10 วิ','<10 วิ'] },
      { key:'b4',  label:'4. ยืนเป็นนั่ง', c:['ใช้มือน้อย ปลอดภัย','คุมลงด้วยมือ','ใช้หลังขาดันเก้าอี้','นั่งเองแต่ทิ้งตัว','ต้องช่วย'] },
      { key:'b5',  label:'5. ย้ายตัว (transfer)', c:['ใช้มือน้อย ปลอดภัย','ต้องใช้มือชัดเจน','ต้องบอก/เฝ้า','ช่วย 1 คน','ช่วย 2 คน'] },
      { key:'b6',  label:'6. ยืนหลับตา (10 วิ)', c:['10 วิ ปลอดภัย','10 วิ ต้องเฝ้า','3 วิ','หลับตาไม่ถึง 3 วิ แต่นิ่ง','ต้องช่วยกันล้ม'] },
      { key:'b7',  label:'7. ยืนเท้าชิด', c:['ชิดเอง+1 นาที ปลอดภัย','1 นาที ต้องเฝ้า','ชิดเองแต่ <30 วิ','ช่วยจัดท่า+ยืน 15 วิ','จัดท่าแล้ว <15 วิ'] },
      { key:'b8',  label:'8. เอื้อมไปข้างหน้า (แขนเหยียด 90°)', c:['>25 ซม.','>12.5 ซม.','>5 ซม.','เอื้อมได้ ต้องเฝ้า','เสีย/ต้องพยุง'] },
      { key:'b9',  label:'9. ก้มเก็บของจากพื้น', c:['เก็บได้ง่าย ปลอดภัย','เก็บได้ ต้องเฝ้า','เหลือ 2–5 ซม.+ทรงตัวเอง','เก็บไม่ได้ ต้องเฝ้า','ทำไม่ได้/ช่วย'] },
      { key:'b10', label:'10. หันมองข้างหลัง ซ้าย-ขวา', c:['2 ข้าง ถ่ายน้ำหนักดี','ข้างเดียวดี อีกข้างน้อย','หันได้แค่ด้านข้าง','ต้องเฝ้า','ต้องช่วย'] },
      { key:'b11', label:'11. หมุนตัว 360°', c:['≤4 วิ ทั้ง 2 ทาง','≤4 วิ ทางเดียว','ปลอดภัยแต่ช้า','ต้องเฝ้า/บอก','ต้องช่วย'] },
      { key:'b12', label:'12. วางเท้าสลับบนสตูล (8/20วิ)', c:['ครบ 8 ใน 20 วิ','ครบ 8 แต่ >20 วิ','4 ครั้ง ต้องเฝ้า','>2 ครั้ง ช่วยเล็กน้อย','ช่วย/ทำไม่ได้'] },
      { key:'b13', label:'13. ยืนเท้าหน้า-หลัง (tandem)', c:['tandem เอง 30 วิ','เท้านำหน้าเอง 30 วิ','ก้าวเล็กเอง 30 วิ','ช่วยก้าว+ยืน 15 วิ','เสียขณะก้าว/ยืน'] },
      { key:'b14', label:'14. ยืนขาเดียว', c:['>10 วิ','5–10 วิ','≥3 วิ','<3 วิ ยังยืนเอง','ทำไม่ได้/ช่วย'] },
    ],
